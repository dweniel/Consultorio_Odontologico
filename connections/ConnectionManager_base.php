...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "ConsultorioOdontologicosqlite3" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["Atendimento_Agendado"] = "ConsultorioOdontologicosqlite3";
		$connectionsIds["Dias_Disponiveis"] = "ConsultorioOdontologicosqlite3";
		$connectionsIds["Contas_a_pagar"] = "ConsultorioOdontologicosqlite3";
		$connectionsIds["Contas_pagas"] = "ConsultorioOdontologicosqlite3";
		$connectionsIds["Paciente"] = "ConsultorioOdontologicosqlite3";
		$connectionsIds["Fornecedores"] = "ConsultorioOdontologicosqlite3";
		$connectionsIds["Produtos"] = "ConsultorioOdontologicosqlite3";
		$connectionsIds["Consultorio_Odontologico_usuarios"] = "ConsultorioOdontologicosqlite3";
