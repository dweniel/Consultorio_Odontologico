...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 6;
		$data["connId"] = "ConsultorioOdontologicosqlite3";
		$data["connName"] = "Consultorio_Odontologico.sqlit";
		$data["connStringType"] = "sqlite";
		$data["connectionString"] = "sqlite;E:\\\\Projects\\\\Consultorio_Odontologico\\\\Consultorio_Odontologico.sqlite3"; //currently unused

		$this->_connectionsIdByName["Consultorio_Odontologico.sqlit"] = "ConsultorioOdontologicosqlite3";
		...
		$data["connInfo"][0] = "E:\\Projects\\Consultorio_Odontologico\\Consultorio_Odontologico.sqlite3";
		$data["connInfo"][1] = "";
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "";
		...
		$data["ODBCString"] = "DRIVER={SQLite3 ODBC Driver};Database=E:\\Projects\\Consultorio_Odontologico\\Consultorio_Odontologico.sqlite3";
		// encription set
		...
		$connectionsData["ConsultorioOdontologicosqlite3"] = $data;
