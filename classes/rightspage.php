...
class RightsPage extends ListPage
{
	...
	function fillGroupsArr()
	{
		...
		while( $tdata = $qResult->fetchAssoc() )
		{
			...
			$this->groups[ $tdata[ $groupIdField ] ] = $label;
		}
	}
	...
	function getRights()
	{
		...
		$sql = "select ". $this->connection->addFieldWrappers( "GroupID" )
			...
			." from ". $this->connection->addTableWrappers( "Consultorio_Odontologicougrights" )
	...
	function updateTablePermissions( $table, $group, $tableRights )
	{
		...
		$rightWTableName = $this->connection->addTableWrappers( "Consultorio_Odontologicougrights" );
