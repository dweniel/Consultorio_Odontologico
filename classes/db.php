...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "ConsultorioOdontologicosqlite3" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "Atendimento_Agendado", "varname" => "ConsultorioOdontologicosqlite3__Atendimento_Agendado", "altvarname" => "Atendimento_Agendado", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Consultorio_Odontologico_settings", "varname" => "ConsultorioOdontologicosqlite3__Consultorio_Odontologico_settings", "altvarname" => "Consultorio_Odontologico_settings", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Consultorio_Odontologico_usuarios", "varname" => "ConsultorioOdontologicosqlite3__Consultorio_Odontologico_usuarios", "altvarname" => "Consultorio_Odontologico_usuarios", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Consultorio_Odontologicouggroups", "varname" => "ConsultorioOdontologicosqlite3__Consultorio_Odontologicouggroups", "altvarname" => "Consultorio_Odontologicouggroups", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Consultorio_Odontologicougmembers", "varname" => "ConsultorioOdontologicosqlite3__Consultorio_Odontologicougmembers", "altvarname" => "Consultorio_Odontologicougmembers", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Consultorio_Odontologicougrights", "varname" => "ConsultorioOdontologicosqlite3__Consultorio_Odontologicougrights", "altvarname" => "Consultorio_Odontologicougrights", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Contas_a_pagar", "varname" => "ConsultorioOdontologicosqlite3__Contas_a_pagar", "altvarname" => "Contas_a_pagar", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Contas_pagas", "varname" => "ConsultorioOdontologicosqlite3__Contas_pagas", "altvarname" => "Contas_pagas", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Dias_Disponiveis", "varname" => "ConsultorioOdontologicosqlite3__Dias_Disponiveis", "altvarname" => "Dias_Disponiveis", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Fornecedores", "varname" => "ConsultorioOdontologicosqlite3__Fornecedores", "altvarname" => "Fornecedores", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Paciente", "varname" => "ConsultorioOdontologicosqlite3__Paciente", "altvarname" => "Paciente", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
			$dalTables[$conn->connId][] = array("name" => "Produtos", "varname" => "ConsultorioOdontologicosqlite3__Produtos", "altvarname" => "Produtos", "connId" => "ConsultorioOdontologicosqlite3", "schema" => "", "connName" => "Consultorio_Odontologico.sqlit");
		}
	}
