...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "ConsultorioOdontologicosqlite3";
		}
		return $connId;
	}
...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("Consultorio_Odontologico_usuarios", PAGE_LIST)
			: null;
	}
	...
	function welcomePageStay()
	{
		return $this->getPageOption("welcome", "welcomePageStay");
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Atendimento_Agendado" ] = array( "url" => "atendimento_agendado", "type" => 0 );
	$projectEntitiesReverse[ "atendimento_agendado" ] = "Atendimento_Agendado";
	$projectEntities[ "Dias_Disponiveis" ] = array( "url" => "dias_disponiveis", "type" => 0 );
	$projectEntitiesReverse[ "dias_disponiveis" ] = "Dias_Disponiveis";
	$projectEntities[ "Contas_a_pagar" ] = array( "url" => "contas_a_pagar", "type" => 0 );
	$projectEntitiesReverse[ "contas_a_pagar" ] = "Contas_a_pagar";
	$projectEntities[ "Contas_pagas" ] = array( "url" => "contas_pagas", "type" => 0 );
	$projectEntitiesReverse[ "contas_pagas" ] = "Contas_pagas";
	$projectEntities[ "Paciente" ] = array( "url" => "paciente", "type" => 0 );
	$projectEntitiesReverse[ "paciente" ] = "Paciente";
	$projectEntities[ "Fornecedores" ] = array( "url" => "fornecedores", "type" => 0 );
	$projectEntitiesReverse[ "fornecedores" ] = "Fornecedores";
	$projectEntities[ "Produtos" ] = array( "url" => "produtos1", "type" => 0 );
	$projectEntitiesReverse[ "produtos1" ] = "Produtos";
	$projectEntities[ "Consultorio_Odontologico_usuarios" ] = array( "url" => "consultorio_odontologico_usuarios", "type" => 0 );
	$projectEntitiesReverse[ "consultorio_odontologico_usuarios" ] = "Consultorio_Odontologico_usuarios";
}
