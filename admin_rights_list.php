...
$pageMask[$table] = $mask;
$tables[$table] = array("atendimento_agendado", " " . "Atendimento Agendado");
...
$pageMask[$table] = $mask;
$tables[$table] = array("dias_disponiveis", " " . "Dias Disponíveis");
...
$pageMask[$table] = $mask;
$tables[$table] = array("contas_a_pagar", " " . "Contas a Pagar");
$table = "Contas_pagas";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("contas_pagas", " " . "Contas Pagas");
$table = "Paciente";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("paciente", " " . "Paciente");
$table = "Fornecedores";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("produtos1", " " . "Produtos");
...
$pageMask[$table] = $mask;
$tables[$table] = array("consultorio_odontologico_usuarios", " " . "Consultorio Odontologico Usuarios");
