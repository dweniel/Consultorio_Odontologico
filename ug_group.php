...
$nonAdminTablesArr[] = "Atendimento_Agendado";
$nonAdminTablesArr[] = "Dias_Disponiveis";
$nonAdminTablesArr[] = "Contas_a_pagar";
$nonAdminTablesArr[] = "Contas_pagas";
$nonAdminTablesArr[] = "Paciente";
$nonAdminTablesArr[] = "Fornecedores";
$nonAdminTablesArr[] = "Produtos";
$nonAdminTablesArr[] = "Consultorio_Odontologico_usuarios";
...
$wGroupTableName = $ug_connection->addTableWrappers( "Consultorio_Odontologicouggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "Consultorio_Odontologicougrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "Consultorio_Odontologicougrights" );
