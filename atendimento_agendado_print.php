...
require_once("include/atendimento_agendado_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "Atendimento_Agendado" );
